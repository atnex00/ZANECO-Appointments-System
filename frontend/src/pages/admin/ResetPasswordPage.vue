...
<style scoped>
.reset-page { width: 100%; min-height: 100vh; background-color: var(--color-gray-50); color: var(--color-gray-900); font-family: var(--font-family); display: flex; align-items: center; justify-content: center; }
...
.form-heading { font-family: var(--font-family-heading); font-size: 1.75rem; font-weight: 600; color: var(--color-gray-900); letter-spacing: -0.02em; line-height: 1.1; text-align: center; }
.form-subtext { font-size: 0.875rem; color: var(--color-gray-600); text-align: center; margin-top: 0.25rem; }
...
.input-icon { position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: var(--color-gray-400); font-size: 1.25rem; pointer-events: none; }
...
.password-hint { font-size: 0.75rem; color: var(--color-danger); margin-top: 0.125rem; }
...
.token-error-icon { font-size: 3rem; color: var(--color-danger); }
.token-error-content h3 { font-family: var(--font-family-heading); font-size: 1.25rem; font-weight: 600; color: var(--color-gray-900); margin: 0; }
.token-error-content p { font-size: 0.875rem; color: var(--color-gray-600); margin: 0; }
