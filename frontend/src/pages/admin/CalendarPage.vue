  ...
  <div>
    ...
    <div class="ap-content">
      ...
      <div v-if="selectedDate" class="ap-table-wrap" style="margin-top:1rem">
        <div style="padding:0.75rem 1rem;font-weight:600;font-size:0.875rem;border-bottom:1px solid var(--color-border);background:var(--color-primary-muted)">
...
/* Calendar card */
.cal-card { background-color: var(--color-white); border: 1px solid var(--color-border); border-radius: var(--radius-xl); padding: 1.25rem; }
.cal-nav { display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem; }
.cal-nav-btn { display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border: 1px solid var(--color-border); background: none; border-radius: 50%; color: var(--color-gray-600); cursor: pointer; }
.cal-nav-btn:hover { background-color: var(--color-primary-muted); }
.cal-nav-btn .material-symbols-outlined { font-size: 1.25rem; }
.cal-month-label { font-size: 1.125rem; font-weight: 700; color: var(--color-gray-900); flex: 1; }
...
.cal-day-num { font-size: 0.875rem; font-weight: 500; color: var(--color-gray-900); }
