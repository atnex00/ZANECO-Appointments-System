...
5. **Write design doc** — save to `docs/design/YYYY-MM-DD-<topic>-design.md` and commit
...
**User Review Gate:**
After the spec is written, ask the user to review it before proceeding. Wait for the user's response. If they request changes, make them. Only proceed once the user approves.

**Implementation:**
- Once the user approves the spec, proceed with implementation
